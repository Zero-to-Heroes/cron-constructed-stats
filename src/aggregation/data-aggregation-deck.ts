...
export const aggregateDeckData = (dailyData: readonly DeckStats[], archetypeData: ArchetypeStats): DeckStats => {
...
const mergeDeckStats = (deckStats: readonly DeckStat[], archetypeData: ArchetypeStats): readonly DeckStat[] => {
...
const mergeDeckStatsForDecklist = (deckStats: readonly DeckStat[], archetypeData: ArchetypeStat): DeckStat => {
	...
	const result: DeckStat = {
		...
		cardsData: cardsData,
		cardVariations: buildCardVariations(deckStats[0].decklist, archetypeData.coreCards),
